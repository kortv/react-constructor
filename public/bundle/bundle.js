...
/***/ function(module, exports, __webpack_require__) {
	...
	function CompControls(_ref) {
	  var handleClick = _ref.handleClick;
	
	  return _react2.default.createElement(
	    'div',
	    { style: { position: 'absolute', zIndex: 99, right: '3%', top: '20px' } },
	    _react2.default.createElement(
	      'a',
	      { onClick: handleClick, 'data-type': 'edit' },
	    ...
	    _react2.default.createElement(
	      'a',
	      { onClick: handleClick, 'data-type': 'pullUp' },
	      _react2.default.createElement('span', { className: 'glyphicon glyphicon-triangle-top', 'aria-hidden': 'true' })
	    ),
	    _react2.default.createElement(
	      'span',
	      null,
	    ...
	    _react2.default.createElement(
	      'a',
	      { onClick: handleClick, 'data-type': 'pullDown' },
	      _react2.default.createElement('span', { className: 'glyphicon glyphicon-triangle-bottom', 'aria-hidden': 'true' })
	    ),
	    _react2.default.createElement(
	      'span',
	      null,
	    ...
	    _react2.default.createElement(
	      'a',
	      { onClick: handleClick, 'data-type': 'del' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DOMProperty = __webpack_require__(17);
	var ReactDOMInstrumentation = __webpack_require__(181);
	var ReactPerf = __webpack_require__(8);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = IconsPicker;
	
	var _react = __webpack_require__(4);
	
	var _react2 = _interopRequireDefault(_react);
	
	var _icons = __webpack_require__(118);
	
	var _icons2 = _interopRequireDefault(_icons);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	function IconsPicker(_ref) {
	  var handleChange = _ref.handleChange;
	  var id = _ref.id;
	
	  var allIcons = _icons2.default.map(function (ico, key) {
	    return _react2.default.createElement(
	      'a',
	      { key: key, onClick: handleChange, 'data-key': id, 'data-value': ico, 'data-type': 'icon', href: '#' },
	      _react2.default.createElement('i', { className: 'icon icon-' + ico })
	    );
	  });
	  return _react2.default.createElement(
	    'div',
	    { className: 'feature-icon-small icon-modal' },
	    allIcons
	  );
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var btoa = (typeof window !== 'undefined' && window.btoa) || __webpack_require__(134);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MainData = __webpack_require__(106);
	
	var _MainData2 = _interopRequireDefault(_MainData);
	
	var _MyNavbar = __webpack_require__(98);
	
	var _MyNavbar2 = _interopRequireDefault(_MyNavbar);
	...
	var _edit = __webpack_require__(121);
	
	var _edit2 = _interopRequireDefault(_edit);
	
	var _pullUp = __webpack_require__(126);
	
	var _pullUp2 = _interopRequireDefault(_pullUp);
	
	var _getData = __webpack_require__(122);
	
	var _getData2 = _interopRequireDefault(_getData);
	
	var _sendData = __webpack_require__(127);
	
	var _sendData2 = _interopRequireDefault(_sendData);
	
	var _del = __webpack_require__(120);
	
	var _del2 = _interopRequireDefault(_del);
	
	var _add = __webpack_require__(119);
	
	var _add2 = _interopRequireDefault(_add);
	
	var _handleChange = __webpack_require__(123);
	
	var _handleChange2 = _interopRequireDefault(_handleChange);
	
	var _handleClick = __webpack_require__(124);
	...
	var Constructor = function (_Component) {
	  ...
	  function Constructor(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Constructor).call(this, props));
	
	    _this.componentDidMount = function () {
	      _this.getData('/constructor.json');
	    };
	
	    _this.edit = _edit2.default.bind(_this);
	    _this.pullUp = _pullUp2.default.bind(_this);
	    _this.getData = _getData2.default.bind(_this);
	    _this.sendData = _sendData2.default.bind(_this);
	    _this.del = _del2.default.bind(_this);
	    _this.add = _add2.default.bind(_this);
	    _this.handleChange = _handleChange2.default.bind(_this);
	    _this.handleClick = _handleClick2.default.bind(_this);
	    _this.state = {
	      userData: [],
	      modalData: {}
	    };
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(_MyNavbar2.default, { handleClick: this.handleClick }),
	          _react2.default.createElement(_MainData2.default, {
	            klass: 'main-container', handleClick: this.handleClick, user: this.state.userData
	          })
	        ),
	        _react2.default.createElement(_Modal2.default, { data: this.state.modalData, handleChange: this.handleChange })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CompControls = __webpack_require__(9);
	
	var _CompControls2 = _interopRequireDefault(_CompControls);
	...
	function About(_ref) {
	  ...
	  var events = content.content ? content.content.map(function (obj, key) {
	    return _react2.default.createElement(
	      'div',
	  ...
	  var style = content.hasOwnProperty('bg') ? { background: 'url(' + content.bg + ')' } : {};
	  return _react2.default.createElement(
	    'section',
	    null,
	    _react2.default.createElement(_CompControls2.default, { handleClick: handleClick }),
	    _react2.default.createElement(
	      'div',
	      { className: 'container' },
	      _react2.default.createElement('div', { className: 'background-image-holder', style: style }),
	      _react2.default.createElement(
	        'div',
	        { className: 'row' },
	        _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Galery(_ref) {
	  var handleClick = _ref.handleClick;
	  var content = _ref.content;
	
	  var photos = content.content ? content.content.map(function (obj, key) {
	    return _react2.default.createElement(
	      'div',
	      { key: key, className: 'col-sm-' + (obj.width || 12) },
	      _react2.default.createElement(
	        'div',
	        { className: 'image-holder' },
	        _react2.default.createElement(
	          'a',
	          { href: obj.pic || 'img/side1.jpg' },
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'image-gallery lightbox-gallery-mrv' },
	          photos
	        )
	      )
	    )
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Header(_ref) {
	  ...
	  var btns = content.content ? content.content.map(function (obj, key) {
	    return _react2.default.createElement(
	      'a',
	      { href: obj.link || '#', key: key, className: 'btn btn-primary btn-white' },
	      obj.name || 'Кнопка'
	    );
	  }) : '';
	  var style = content.hasOwnProperty('bg') ? { background: 'url(' + content.bg + ')' } : {};
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'h1',
	            { className: 'text-white space-bottom-medium' },
	            content.header
	          ),
	          btns
	        )
...
/***/ function(module, exports, __webpack_require__) {
	...
	function History(_ref) {
	  ...
	  var allContents = content.content ? content.content.map(function (obj, key) {
	    return (key + 1) % 2 ? _react2.default.createElement(
	      'div',
	      { key: key, className: 'timeline-event' },
	      _react2.default.createElement(
	        'div',
	      ...
	      _react2.default.createElement(
	        'div',
	        { className: 'middle' },
	        _react2.default.createElement('i', { className: 'icon icon-' + (obj.icon || 'genius') }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Jobs(_ref) {
	  ...
	  var jobs = content.content ? content.content.map(function (obj, key) {
	    var element = _react2.default.createElement(
	      'div',
	      { key: key, className: 'col-sm-6' },
	      _react2.default.createElement(
	        'a',
	        { href: obj.url },
	        _react2.default.createElement(
	    ...
	    'h3',
	    { className: 'text-center col-xs-offset-1 col-xs-10' },
	    'Вакансии подгрузяться после сохранения данных на сервер'
	  );
	  var leng = jobs.length;
	  for (leng; leng >= 1; leng--) {
	    if (!(leng % 2)) {
	      jobs.splice(leng, 0, _react2.default.createElement('div', { key: 'row' + leng, className: 'col-xs-12' }));
	    }
	  }
	  return _react2.default.createElement(
	    'section',
...
/***/ function(module, exports, __webpack_require__) {
	...
	function NavBar(_ref) {
	  ...
	  return _react2.default.createElement(
	    'nav',
	    { className: 'simple-bar', style: { position: 'relative' } },
	    _react2.default.createElement(
	      'div',
	      { className: 'container' },
	      _react2.default.createElement(
	        'div',
	        { className: 'row nav-menu' },
	        _react2.default.createElement(
	          'div',
	          { className: 'columns text-left col-md-12' },
	          _react2.default.createElement(
	            'ul',
	            { className: 'menu' },
	            _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'a',
	                { 'data-type': 'add', onClick: handleClick, href: '#' },
	                'Добавить поле'
	              )
	            ),
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'a',
	                { onClick: handleClick, 'data-type': 'sendData', href: '#' },
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement('i', { className: 'icon icon_menu' })
	      )
	    )
	  );
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function NavBar(_ref) {
	  ...
	  var btns = content.content.map(function (obj, key) {
	    return _react2.default.createElement(
	      'li',
	      { key: key },
	      _react2.default.createElement(
	...
	function Social(_ref) {
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'div',
	        { className: 'col-sm-4 no-pad col-md-4' },
	        _react2.default.createElement(
	          'a',
	          { href: content.content[0].twitter },
	          _react2.default.createElement(
	            'div',
	            { className: 'link bg-twitter' },
	            _react2.default.createElement(
	              'div',
	              { className: 'initial' },
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'a',
	          { href: content.content[0].fb },
	          _react2.default.createElement(
	            'div',
	            { className: 'link bg-facebook' },
	            _react2.default.createElement(
	              'div',
	              { className: 'initial' },
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'a',
	          { href: content.content[0].vk },
	          _react2.default.createElement(
	            'div',
	            { className: 'link bg-vk' },
	            _react2.default.createElement(
	              'div',
	              { className: 'initial' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Team(_ref) {
	  ...
	  var workers = content.content ? content.content.map(function (obj, key) {
	    var element = _react2.default.createElement(
	      'div',
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement('img', {
	          className: 'img-circle', height: '200', alt: 'Наш сотрудник...',
	          src: obj.pic || 'img/team-small-1.png'
	        }),
	        _react2.default.createElement(
	          'h2',
	          null,
	        ...
	        _react2.default.createElement(
	          ...
	          obj.txt || 'Информация о сотруднике'
	        )
	      )
	    );
	    return element;
	  }) : '';
	  var leng = workers.length;
	  for (leng; leng >= 1; leng--) {
	    if (!(leng % 3)) {
	      workers.splice(leng, 0, _react2.default.createElement('div', { key: 'row' + leng, className: 'col-xs-12' }));
	    }
	  }
	  return _react2.default.createElement(
	    'section',
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'row space-bottom-large' },
	          workers
	        )
	      )
	    )
	...
	function Values(_ref) {
	  ...
	  var allContents = content.content ? content.content.map(function (obj, key) {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'div',
	        { className: 'feature feature-icon-large' },
	        _react2.default.createElement(
	          'div',
	          { className: 'pull-left' },
	          _react2.default.createElement('i', { className: 'icon icon-' + (obj.icon || 'genius') })
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      'div',
	      { className: 'duplicatable-content' },
	      _react2.default.createElement(
	        'div',
	        { className: 'container' },
	        _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'h1',
	            { className: 'space-bottom-medium' },
	            content.header
	          ),
	          _react2.default.createElement(
	            'p',
	            { className: 'lead space-bottom-medium' },
	            content.text
	          )
	        ),
	        _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Social = __webpack_require__(100);
	
	var _Social2 = _interopRequireDefault(_Social);
	
	var _History = __webpack_require__(96);
	...
	var _Galery = __webpack_require__(94);
	
	var _Galery2 = _interopRequireDefault(_Galery);
	...
	var _Jobs = __webpack_require__(97);
	...
	function ConContent(_ref) {
	  var handleClick = _ref.handleClick;
	  var cont = _ref.cont;
	
	  var Element = _react2.default.createElement('div', null);
	  switch (cont.type) {
	    case 'Header':
	      Element = _Header2.default;
	      break;
	
	    case 'Navbar':
	      Element = _Navbar2.default;
	      break;
	
	    case 'About':
	      Element = _About2.default;
	      break;
	
	    case 'Jobs':
	      Element = _Jobs2.default;
	      break;
	
	    case 'Values':
	      Element = _Values2.default;
	      break;
	
	    case 'Team':
	      Element = _Team2.default;
	      break;
	
	    case 'HistoryComp':
	      Element = _History2.default;
	      break;
	
	    case 'Galery':
	      Element = _Galery2.default;
	      break;
	
	    case 'Video':
	      Element = _Video2.default;
	      break;
	
	    case 'Social':
	      Element = _Social2.default;
	      break;
	
	    case 'TextComp':
	      Element = _Text2.default;
	      break;
	  ...
	  return _react2.default.createElement(Element, { content: cont, handleClick: handleClick });
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = MainData;
	
	var _react = __webpack_require__(4);
	
	var _react2 = _interopRequireDefault(_react);
	
	var _ConContent = __webpack_require__(105);
	
	var _ConContent2 = _interopRequireDefault(_ConContent);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	function MainData(_ref) {
	  ...
	  if (user.length) {
	    var userCont = user.map(function (cont, key) {
	      return _react2.default.createElement(_ConContent2.default, { cont: cont, handleClick: handleClick, key: key });
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MText = __webpack_require__(115);
	
	var _MText2 = _interopRequireDefault(_MText);
	
	var _MHeader = __webpack_require__(110);
	
	var _MHeader2 = _interopRequireDefault(_MHeader);
	
	var _MNavbar = __webpack_require__(112);
	
	var _MNavbar2 = _interopRequireDefault(_MNavbar);
	
	var _MValues = __webpack_require__(116);
	
	var _MValues2 = _interopRequireDefault(_MValues);
	
	var _MTeam = __webpack_require__(114);
	
	var _MTeam2 = _interopRequireDefault(_MTeam);
	
	var _MHistory = __webpack_require__(111);
	
	var _MHistory2 = _interopRequireDefault(_MHistory);
	
	var _MGalery = __webpack_require__(109);
	
	var _MGalery2 = _interopRequireDefault(_MGalery);
	
	var _MVideo = __webpack_require__(117);
	
	var _MVideo2 = _interopRequireDefault(_MVideo);
	
	var _MSocial = __webpack_require__(113);
	
	var _MSocial2 = _interopRequireDefault(_MSocial);
	
	var _MAbout = __webpack_require__(108);
	...
	function Modal(_ref) {
	  ...
	  switch (data.type) {
	    case 'Header':
	      Element = _MHeader2.default;
	      break;
	
	    case 'About':
	      Element = _MAbout2.default;
	      break;
	
	    case 'Navbar':
	      Element = _MNavbar2.default;
	      break;
	
	    case 'Values':
	      Element = _MValues2.default;
	      break;
	
	    case 'Team':
	      Element = _MTeam2.default;
	      break;
	
	    case 'HistoryComp':
	      Element = _MHistory2.default;
	      break;
	
	    case 'Galery':
	      Element = _MGalery2.default;
	      break;
	
	    case 'Video':
	      Element = _MVideo2.default;
	      break;
	
	    case 'Social':
	      Element = _MSocial2.default;
	      break;
	
	    case 'TextComp':
	      Element = _MText2.default;
	      break;
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'button',
	              { onClick: handleChange, 'data-type': 'close', type: 'button', className: 'close' },
	              _react2.default.createElement(
	                'span',
	                { 'aria-hidden': 'true' },
	                '×'
	          ...
	          _react2.default.createElement(Element, { content: data, handleChange: handleChange })
	        )
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	function ModalHeader(_ref) {
	  ...
	  var btns = content.content ? content.content.map(function (obj, key) {
	    return _react2.default.createElement(
	      'div',
	      { className: 'main-container', key: key },
	      _react2.default.createElement(
	        'div',
	        { className: 'col-xs-8' },
	        _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'a',
	          {
	            href: '#', onClick: handleChange, 'data-type': 'del-btn',
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement('input', {
	          className: 'form-control', type: 'text', placeholder: 'Достижение',
	      ...
	      _react2.default.createElement(
	        ...
	        { className: 'col-xs-8' },
	        _react2.default.createElement('input', {
	          className: 'form-control', type: 'text', placeholder: 'достигнутое число',
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement('textarea', {
	          placeholder: 'Заголовок компонента',
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'span',
	          { className: 'file-input btn btn-default btn-file' },
	          'Выберите файл… ',
	          _react2.default.createElement('input', { type: 'file', onChange: handleChange, 'data-type': 'bg' })
	        )
	      ),
	      _react2.default.createElement(
	        'div',
	        { className: 'col-sm-8' },
	        _react2.default.createElement('img', { className: 'center-block', src: content.bg, height: '200', alt: 'фоновая картинка...' })
	      ),
	      _react2.default.createElement(
	        'div',
	        ...
	        _react2.default.createElement(
	          'a',
	          { href: '#', onClick: handleChange, 'data-type': 'add-btn', className: 'btn' },
	          'Добавить кнопку ',
	          _react2.default.createElement(
	            'span',
	            { 'aria-hidden': 'true' },
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          { className: 'file-input btn btn-default btn-file' },
	          'Выберите файл…',
	          _react2.default.createElement('input', { type: 'file', 'data-key': key, onChange: handleChange, 'data-type': 'pic' })
	        ),
	        _react2.default.createElement(
	          'label',
	          { className: 'control-label' },
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            'выберите ширину фотографии от 1 до 12'
	          ),
	          _react2.default.createElement('input', {
	      ...
	      _react2.default.createElement(
	        'div',
	        { className: 'col-sm-12' },
	        _react2.default.createElement('img', { className: 'center-block', src: obj.pic || 'img/side1.jpg', alt: '' })
	      )
	    );
	  }) : '';
	  return _react2.default.createElement(
	  ...
	  var btns = content.content ? content.content.map(function (obj, key) {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        { className: 'col-xs-4' },
	        _react2.default.createElement('input', {
	          className: 'form-control', type: 'text', placeholder: 'название кнопки',
	          onChange: handleChange, defaultValue: obj.name, 'data-type': 'name', 'data-key': key
	        })
	      ),
	      _react2.default.createElement(
	        ...
	        { className: 'col-xs-8' },
	        _react2.default.createElement('input', {
	          className: 'form-control', type: 'text', placeholder: 'ссылка кнопки',
	          onChange: handleChange, defaultValue: obj.link, 'data-type': 'link', 'data-key': key
	        })
	      )
	    );
	  }) : '';
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = MHistory;
	
	var _react = __webpack_require__(4);
	
	var _react2 = _interopRequireDefault(_react);
	
	var _IconPicker = __webpack_require__(57);
	
	var _IconPicker2 = _interopRequireDefault(_IconPicker);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	function MHistory(_ref) {
	  var handleChange = _ref.handleChange;
	  var content = _ref.content;
	
	  var events = content.content ? content.content.map(function (obj, key) {
	    var icons = obj.iconList ? _react2.default.createElement(_IconPicker2.default, { handleChange: handleChange, id: key }) : '';
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'button',
	              {
	                style: { minWidth: 'auto' }, onClick: handleChange, 'data-key': key,
	            ...
	            _react2.default.createElement(
	              'div',
	              { className: 'col-sm-3 feature-icon-small', style: { marginBottom: 0 } },
	              _react2.default.createElement(
	                'i',
	                { style: { marginBottom: 0 }, className: 'icon icon-' + (obj.icon || 'genius') },
	                ' '
	              )
	            )
	          )
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'a',
	          {
	            href: '#', onClick: handleChange, 'data-type': 'del-btn', 'data-key': key,
	      ...
	      _react2.default.createElement(
	        ...
	        { className: 'col-xs-4' },
	        _react2.default.createElement('input', {
	          className: 'form-control', type: 'text', placeholder: 'наименование',
	          onChange: handleChange, defaultValue: obj.name, 'data-type': 'name', 'data-key': key
	        })
	      ),
	      _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'a',
	            { href: '#', onClick: handleChange, 'data-type': 'add-btn', className: 'btn pull-right' },
	            'Добавить кнопку ',
	            _react2.default.createElement(
	              'span',
	              { 'aria-hidden': 'true' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	function MSocial(_ref) {
	  var handleChange = _ref.handleChange;
	  var content = _ref.content;
	
	  var cont = content.content[0];
	  return _react2.default.createElement(
	    'div',
	    { className: 'modal-body' },
	    _react2.default.createElement(
	  ...
	  var workers = content.content ? content.content.map(function (obj, key) {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement('img', {
	          className: 'center-block', alt: 'Фото сотрудника...',
	          src: obj.pic || 'img/team-small-1.png'
	        })
	      ),
	      _react2.default.createElement(
	        ...
	        { className: 'col-sm-4' },
	        _react2.default.createElement('input', {
	          className: 'form-control', type: 'text', placeholder: 'Имя Фамилия',
	          onChange: handleChange, defaultValue: obj.name, 'data-type': 'name', 'data-key': key
	        })
	      ),
	      _react2.default.createElement(
	        ...
	        { className: 'col-sm-4' },
	        _react2.default.createElement('input', {
	          className: 'form-control', type: 'text', placeholder: 'Должность сотрудника',
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement('textarea', {
	          placeholder: 'Информация о сотрунике', style: { minHeight: '100px' },
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          { className: 'col-sm-9' },
	          _react2.default.createElement('input', {
	            className: 'form-control', type: 'text', 'data-type': 'videoLink', 'data-key': '0',
...
/***/ function(module, exports) {
	...
	var icons = ['adjustments', 'alarmclock', 'anchor', 'aperture', 'attachment', 'bargraph', 'basket', 'beaker', 'bike', 'book-open', 'briefcase', 'browser', 'calendar', 'camera', 'caution', 'chat', 'circle-compass', 'clipboard', 'clock', 'cloud', 'compass', 'desktop', 'dial', 'document', 'documents', 'download', 'dribbble', 'edit', 'envelope', 'expand', 'facebook', 'flag', 'focus', 'gears', 'genius', 'gift', 'global', 'globe', 'googleplus', 'grid', 'happy', 'hazardous', 'heart', 'hotairballoon', 'hourglass', 'key', 'laptop', 'layers', 'lifesaver', 'lightbulb', 'linegraph', 'linkedin', 'lock', 'magnifying-glass', 'map', 'map-pin', 'megaphone', 'mic', 'mobile', 'newspaper', 'notebook', 'paintbrush', 'paperclip', 'pencil', 'phone', 'picture', 'pictures', 'piechart', 'presentation', 'pricetags', 'printer', 'profile-female', 'profile-male', 'puzzle', 'quote', 'recycle', 'refresh', 'ribbon', 'rss', 'sad', 'scissors', 'scope', 'search', 'shield', 'speedometer', 'strategy', 'streetsign', 'tablet', 'target', 'telescope', 'toolbox', 'tools', 'tools-2', 'trophy', 'tumblr', 'twitter', 'upload', 'video', 'wallet', 'wine'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _initialData = __webpack_require__(125);
	...
	function add(elem) {
	  var type = elem.parentNode.previousSibling.childNodes[0].value;
	  var data = this.state.userData;
	  var addData = _extends({}, _initialData2.default[type]);
...
/***/ function(module, exports) {
	...
	function del(idx) {
	  var data = [].concat(_toConsumableArray(this.state.userData));
	  data.splice(idx, 1);
	  this.setState({
	    userData: data
	  });
...
/***/ function(module, exports) {
	...
	function edit(idx) {
	  var modal = _extends({}, this.state.userData[idx]);
	  if (modal.type === 'Jobs') {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getData(path) {
	  ...
	  _axios2.default.get(path).then(function (data) {
	    console.log(data);
	    var mainData = [];
	    if (data.data.blocks) {
	      mainData = [].concat(_toConsumableArray(data.data.blocks));
	      if (data.data.jobs) {
	        var jobs = mainData.filter(function (obj) {
	          return obj.type === 'Jobs';
	        });
	        var index = mainData.indexOf(jobs[0]);
	        mainData[index].content = [].concat(_toConsumableArray(jobs));
	      }
	    } else if (data.data.events) {
	      mainData = [].concat(_toConsumableArray(data.data.events)).map(function (obj) {
	        return _extends({}, obj, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function handleChange(e) {
	  ...
	  var modal = _extends({}, this.state.modalData);
	  var data = [].concat(_toConsumableArray(this.state.userData));
	  var idx = e.currentTarget.getAttribute('data-key');
	  var objId = data.filter(function (obj) {
	    return obj.id === modal.id;
	  });
	  var index = data.indexOf(objId[0]);
	  ...
	  if (type === 'close') {
	    ...
	    var _value = e.currentTarget.getAttribute('data-value');
	    modal.content[idx].iconList = false;
	    data[index].content[idx][type] = _value;
	    modal.content[idx][type] = _value;
	    ...
	    if (file) {
	      ...
	      _axios2.default.defaults.headers['X-CSRF-Token'] = AUTH_TOKEN;
	
	      _axios2.default.post('/images.json', formData).then(function (response) {
	        if (response) {
	          console.log(response);
	          var _value2 = response.data.url;
	          data[index][type] = _value2;
	          modal[type] = _value2;
	    ...
	    if (_file) {
	      ...
	      _formData.append('image[file]', _file);
	
	      var _AUTH_TOKEN = document.querySelector('meta[name="csrf-token"]').getAttribute('content');
	      _axios2.default.defaults.headers['X-CSRF-Token'] = _AUTH_TOKEN;
	
	      _axios2.default.post('/images.json', _formData).then(function (response) {
	        if (response) {
	          console.log(response);
	          var _value3 = response.data.url;
	          data[index].content[idx][type] = _value3;
	          modal.content[idx][type] = _value3;
	    ...
	    var regExp = /(?:^.*youtu\.?be.*\/(?:watch\?v=)?(.+)\/?$)|(?:^.*vimeo\.com.*\/(\d+)\/?$)/g;
	    var _value4 = video.replace(regExp, function (str, a, b) {
	      if (a) {
	    ...
	    data[index].content[idx][type] = _value4;
	    ...
	    // console.log(objId)
	    // console.log(index)
	    var _value5 = e.target.value;
	    // console.log(data[index].content[idx])
	    data[index].content[idx][type] = _value5;
...
/***/ function(module, exports) {
	...
	function handleClick(e) {
	  ...
	  var attr = element.getAttribute('data-type');
	  var item = element.parentNode.parentNode;
	  var items = [].concat(_toConsumableArray(item.parentNode.children));
...
/***/ function(module, exports) {
	...
	var initialData = {
	  Values: {
	    ...
	    content: [{
	      head: 'Chip Mayer',
	      txt: 'Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium ' + 'laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore et quasi ' + 'beatae vitae dicta sunt explicabo.',
	      icon: 'hazardous',
	      iconList: false
	    }, {
	      head: 'Chip Mayer',
	  ...
	  TextComp: {
	    ...
	    type: 'TextComp',
	    header: 'Заголовок',
	    text: 'Далеко-далеко за словесными горами в стране, ' + 'гласных и согласных живут рыбные тексты. Запятой она, ' + 'продолжил, страну семь пустился грустный семантика букв подзаголовок.',
	    content: []
	  },
	  Navbar: {
	    id: 2,
	  ...
	  HistoryComp: {
	    ...
	    type: 'HistoryComp',
	    header: 'Заголовок',
	    text: 'Наша компания появилась сравнительно недавно, но уже ' + 'добилась выдающихся результатов. Мы хотели бы рассказать ' + 'о ключевых этапах развития Company Name',
	    content: [{
	      year: 2006,
	      head: 'Первые шаги',
	      txt: 'За год компания выросла из небольшого бизнеса ' + 'в крупное производство. Все дети Америки мечтали получить ' + 'в подарок игрушку Company Name.',
	      icon: 'telescope',
	      iconList: false
	    }, {
	      year: 2009,
	      head: 'Заголовок2',
	      txt: 'Летом 2011 года Company Name заключила договор ' + 'с крупнейшим магазином игрушек Shameleys.',
	      icon: 'global',
	      iconList: false
	    }]
	  },
	  ...
	  Galery: {
	    ...
	    text: 'Никакие глобальные вещи не создаются в одиночку. А все вместе, ' + 'командой, мы можем создать что-то большое. Мы усердно работаем, много ' + 'смеемся, постоянно обсуждаем новые идеи и у нас отлично это получается вместе!',
	    content: [{
	      pic: 'img/side1.jpg',
	      width: 8
	    }, {
	  ...
	  Video: {
	    ...
	    text: 'В этот блок вы можете загрузить видео' + 'с youtube или vimeo. Для этого просто добавьте ссылку на вашу видеозапись.',
	    content: [{ videoLink: 'http://www.youtube.com/embed/SZEflIVnhH8' }]
	  },
	  Social: {
	    id: 11,
	    type: 'Social',
...
/***/ function(module, exports) {
	...
	function pullUp(idx, way) {
	  var data = this.state.userData;
	  var temp = data[idx + way];
...
/***/ function(module, exports, __webpack_require__) {
	...
	function sendData() {
	  ...
	  _axios2.default.post('/constructor.json', {
	    construct: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Constructor = __webpack_require__(92);
	
	var _Constructor2 = _interopRequireDefault(_Constructor);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	(0, _reactDom.render)(_react2.default.createElement(_Constructor2.default, null), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getNativeComponentFromComposite = __webpack_require__(87);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDOMDebugTool = __webpack_require__(175);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactInvalidSetStateWarningDevTool = __webpack_require__(196);
	var warning = __webpack_require__(3);
